# -*- coding: utf-8 -*-
"""
Created on Sun Feb 18 01:15:33 2018
...
special_label = optimizer_label + "_SegNetSkip"
...
concat1 = Concatenate(axis=-1)([xct2b, xmp12])
...
concat2 = Concatenate(axis=-1)([xct5b, xmp9])
...
concat3 = Concatenate(axis=-1)([xct8b, xmp6])
...
concat4 = Concatenate(axis=-1)([xct11b, xmp3])
