# -*- coding: utf-8 -*-
"""
Created on Mon Feb 19 19:20:56 2018
...
special_label = optimizer_label + "_SegNetIncp13"
...
inception1_12 = Conv2D(512, (1, 1), padding='same', activation='relu',
                       strides=(1, 1))(xmp12)
inception3_12 = Conv2D(512, (3, 3), padding='same', activation='relu',
                       strides=(1, 1))(xmp12)
inception1_12b = BatchNormalization(axis=-1, momentum=0.99, epsilon=0.001)(inception1_12)
inception3_12b = BatchNormalization(axis=-1, momentum=0.99, epsilon=0.001)(inception3_12)
concat1 = Concatenate(axis=-1)([xct2b, inception1_12b, inception3_12b])
...
inception1_9 = Conv2D(256, (1, 1), padding='same', activation='relu', 
                      strides=(1, 1))(xmp9)
inception3_9 = Conv2D(256, (3, 3), padding='same', activation='relu', 
                      strides=(1, 1))(xmp9)
inception1_9b = BatchNormalization(axis=-1, momentum=0.99, epsilon=0.001)(inception1_9)
inception3_9b = BatchNormalization(axis=-1, momentum=0.99, epsilon=0.001)(inception3_9)
concat2 = Concatenate(axis=-1)([xct5b, inception1_9b, inception3_9b])
...
inception1_6 = Conv2D(128, (1, 1), padding='same', activation='relu', 
                      strides=(1, 1))(xmp6)
inception3_6 = Conv2D(128, (3, 3), padding='same', activation='relu', 
                      strides=(1, 1))(xmp6)
inception1_6b = BatchNormalization(axis=-1, momentum=0.99, epsilon=0.001)(inception1_6)
inception3_6b = BatchNormalization(axis=-1, momentum=0.99, epsilon=0.001)(inception3_6)
concat3 = Concatenate(axis=-1)([xct8b, inception1_6b, inception3_6b])
...
inception1_3 = Conv2D(64, (1, 1), padding='same', activation='relu', 
                      strides=(1, 1))(xmp3)
inception3_3 = Conv2D(64, (3, 3), padding='same', activation='relu', 
                      strides=(1, 1))(xmp3)
inception1_3b = BatchNormalization(axis=-1, momentum=0.99, epsilon=0.001)(inception1_3)
inception3_3b = BatchNormalization(axis=-1, momentum=0.99, epsilon=0.001)(inception3_3)
concat4 = Concatenate(axis=-1)([xct11b, inception1_3b, inception3_3b])
...
predictions = Conv2D(3, (1, 1), padding='same', activation='softmax')(xct14b)
